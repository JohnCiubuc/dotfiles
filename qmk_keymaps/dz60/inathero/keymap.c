...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_64_ansi( /* Layer 0: Qwerty */
        ...
        SHFT_CAP, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH,KC_RSFT,     MO(_RGBL),      MO(_FUNCTION),
    ...
    [_COLEMAK] = LAYOUT_64_ansi( /* Layer 0: Qwerty */
        ...
        SHFT_CAP,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_RGBL),      MO(_FUNCTION),
        KC_LCTL, KC_LALT, KC_LGUI,                     KC_SPC,              KC_RALT, KC_LEFT, KC_DOWN,     KC_UP,   KC_RIGHT
    ),
    ...
    [_RGBL] = LAYOUT_64_ansi( /* Layer 0: Qwerty */
        ...
        RGB_HUI,            RGB_SAI,             RGB_VAI,           XXXX,               XXXX, XXXX,  XXXX,    XXXX,       XXXX,    XXXX,   XXXX,      XXXX,   XXXX,   XXXX,
